...
% By Jacques Berg
%
% If you are using Octave, you need to have signal processing package installed.
% Most installers install that automatically, you can check whether it has been installed by the command_line_path
%   pkg list
% If not, install it
...
ss = sin(2*pi*250*tt);      % sinusoidal signal with a frequency of 250Hz (fs/f, 8000/250=32 is integer to prevent spectral leakage)
sound(ss,Fs)
